                                        ...
                                        <tr id="row1">
                                            ...
                                            <td>
                                                <form method="post">
                                                    ...
                                                    <button type="submit" class="update" name="updateRole"><img src="../../../dash_img/1688988.png" width="20px"></button>
                                                </form>
                                            </td>
                                            ...
                                            <td id="edit"> <a href="user_review.php?user_id=<?php echo $value['id'] ?>"><img src="../../../dash_img/3207604.png" width="20px" alt=""></a></td>
                                            <td class=""> <a href="?user_id=<?php echo $value['id'] ?>"><img src="../../../dash_img/5675840.png" width="20px" alt=""></a> </td>

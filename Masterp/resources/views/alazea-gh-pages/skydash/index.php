  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row"  >
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" >
        <a class="navbar-brand brand-logo mr-10" href="index.php"><img src="images/LOGOss.PNG" class="mr-2"  style="height: 60px ;   border-radius: 50%;
" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini"  href="index.php"><img  src="images/LOGOss.PNG" alt="logo" ></a>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/prodacts/all_products.php">All Products</a></li>
                <?php
                while ($category = $categories->fetch_assoc()) { ?>
                  <li class="nav-item"><a class="nav-link" href="pages/prodacts/proudact.php?category_id=<?php echo $category['id'] ?>"><?php echo $category['category_name'] ?></a></li>
                <?php } ?>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="users-collapse">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/prodacts/users.php">Users</a></li>
                <!-- <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Users Comment</a></li> -->
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/prodacts/discount.php">
              <i class="icon-columns menu-icon"></i>
              <span class="menu-title">Discounts</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/prodacts/orders.php">
              <i class="icon-columns menu-icon"></i>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold"> welocme  <?php echo $_SESSION['user_name']?> </h3>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Number Of Product</p>

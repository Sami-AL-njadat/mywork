            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-100">
                        ...
                        <div class="product-img">
                            <a href="shop-details.html"><img src="{{ asset('front_end/img/bg-img/40.png') }}"
                                    alt="" /></a>
                            <!-- Product Tag -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-100">
                        <!-- Product Image -->
                        <div class="product-img">
                            <a href="shop-details.html"><img src="{{ asset('front_end/img/bg-img/41.png') }}"
                                    alt="" /></a>
                            <div class="product-meta d-flex">
                                <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-100">
                        <!-- Product Image -->
                        <div class="product-img">
                            <a href="shop-details.html"><img src="{{ asset('front_end/img/bg-img/42.png') }}"
                                    alt="" /></a>
                            <div class="product-meta d-flex">
                                <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-100">
                        <!-- Product Image -->
                        <div class="product-img">
                            <a href="shop-details.html"><img src="{{ asset('front_end/img/bg-img/43.png') }}"
                                    alt="" /></a>
                            <!-- Product Tag -->
